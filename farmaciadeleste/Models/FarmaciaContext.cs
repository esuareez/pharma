...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=farmaciadeleste.database.windows.net;Database=Farmacia;User ID=eliam;Password=E1234567-;Trusted_Connection=true;Integrated Security=False;MultipleActiveResultSets=true");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FormaPago>(entity =>
            {
                ...
                entity.HasIndex(e => e.Descripcion, "UQ__FormaPag__92C53B6C98B99BBE")
                    .IsUnique();
