            ...
            const dataToTable = function (t) {
                ...
                defaultConfig = {
                    ...
                    labels: {
                        placeholder: "Buscar...",
                        perPage: "{select}",
                        noRows: "No se encuentra el producto.",
                        info: "Mostrando del {start} al {end} de {rows} productos."
                    },
                    layout: {
                        top: "{select}{search}",
                        bottom: "{info}{pager}"
            ...
            class DataTable {
                ...
                render(t) {
                    ...
                    if (this.headings = [], this.hasHeadings = this.head.rows.length > 0, this.hasHeadings && (this.header = this.head.rows[0], this.headings = [].slice.call(this.header.cells)), e.header || this.head && this.table.removeChild(this.table.tHead), e.footer ? this.head && !this.foot && (this.foot = createElement("tfoot", {
                        ...
                        let t = "<div class='dataTable-dropdown ' style='width: 80px'>"; // style agregado para achicar la barra del total a buscar
